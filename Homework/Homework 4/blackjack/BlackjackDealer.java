...
public class BlackjackDealer {
	...
	private void hitPlayer() {
		...
		if (c == null) { // dealing first card is null
			System.out.println("wow the first card is null");
		}
		// System.out.println("TOP CARD OF DECK: " + c);
	...
	protected void playHand(int handNum) {
		...
		// System.out.println("player hand AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA: " +
		// this.playerHand);
		...
		// my own syntax below
		System.out.println("CARDS IN DECK: " + decks.cardsLeft());
		System.out.println("WE ARE CURRENTLY USING THE " + decks.getdeckNumber() + "th deck");
		// my own syntax above
