 ...
 * @version 1.1
 *          This class tests a custom built linked list by comparing it with
...
public class Tester {
	...
	public static void main(String[] args) {
		...
		// System.out.println("should be 4: " + testList.size());
		...
		for (int i = 0; i < NUM_TESTS; i++) {
			...
			// System.out.println("THIS IS COMPLIST: " + compList);
			// System.out.println("THIS IS STUDLIST: " + studList);
		...
		for (int i = 0; i < NUM_TESTS; i++) {
			...
			// System.out.println("inserting " + rand + " at " + ind + " stuList " +
			// studList.toString());
			if (!compareLists(compList, studList)) {
		...
		for (int i = compList.size() - 1; i > 0; i--) {
			...
			if (!(compareLists(compList, studList))) {
				System.out.println(
						"ERROR: remove by iterator method failed. This could also be because your iterator is not iterating backwards through the list correctly.");
				System.exit(1);
			}
		}
		System.out.println("Done. Looks good");
