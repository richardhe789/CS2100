...
public class TestVector {
	...
	public static int NUM_TESTS = 100;// 5000;
	...
	private static <T> boolean compareLists(java.util.LinkedList<T> list1, vector.Vector<T> list2) {
		...
		if (list1.size() != list2.size()) {
			System.out.println("comparing list: " + list1.size());
			System.out.println("vector list: " + list2.size());
			System.out.println("Size is wrong");
			return false;
		}
		while (it2 < list2.size()) {
			if (!it1.next().equals(list2.get(it2)))
				return false;
			it2++;
		}
		return true;
	...
	public static void main(String[] args) {
		...
		/*
		 * Test the two lists by inserting and removing stuff and checking equality as
		 * we go
		 */
		...
		for (int i = 0; i < NUM_TESTS; i++) {
			...
			// System.out.println("Comparing list: " + compList);
			...
			// System.out.println("I am currently on the " + i + "th test.");
		}
		System.out.println("Done. Looks good"); // this is good
		...
		for (int i = 0; i < NUM_TESTS; i++) {
			...
			if (!compareLists(compList, studList)) {
				// System.out.println("compared list: " + compList);
				// System.out.println("randomly generated list: " + studList);
